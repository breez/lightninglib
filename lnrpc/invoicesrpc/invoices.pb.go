...
package invoicesrpc // import "github.com/breez/lightninglib/lnrpc/invoicesrpc"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import lnrpc "github.com/breez/lightninglib/lnrpc"
...
func (*CancelInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{0}
}
...
func (*CancelInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{1}
}
...
func (*AddHoldInvoiceRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{2}
}
...
func (*AddHoldInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{3}
}
...
func (*SettleInvoiceMsg) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{4}
}
...
func (*SettleInvoiceResp) Descriptor() ([]byte, []int) {
	return fileDescriptor_invoices_460ef4f3f4ad04f7, []int{5}
}
...
func init() {
	proto.RegisterFile("invoicesrpc/invoices.proto", fileDescriptor_invoices_460ef4f3f4ad04f7)
}

var fileDescriptor_invoices_460ef4f3f4ad04f7 = []byte{
	...
	,
}
