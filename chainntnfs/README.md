...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/"github.com/breez/lightninglib/chainntnfs)
...
```bash
$ go get -u "github.com/breez/lightninglib/chainntnfs
```
